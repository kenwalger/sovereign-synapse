...
- **`vault/keys/`** — Local Ed25519 signing material (`sovereign_signing.key` / `.pub`; absolute path under repo root, generated on first ingest; the ingest user and MCP process must have **read** access; never commit)
